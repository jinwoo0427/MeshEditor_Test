...
{
    [CustomEditor(typeof(PaintManagerEx))]
    public class PaintManagerExInspector : UnityEditor.Editor
    {
        ...
        private PaintManagerEx paintManager;
        ...
        static void AddPaintManagerObject()
        {
            ...
            gameObject.AddComponent<PaintManagerEx>();
        ...
        {
            if (Selection.activeGameObject != null && !Selection.activeGameObject.TryGetComponent<PaintManagerEx>(out _))
            {
                Selection.activeGameObject.AddComponent<PaintManagerEx>();
            }
        }
        ...
        void OnEnable()
        {
            paintManager = (PaintManagerEx)target;
